...
/mob/living/simple_animal/hostile/retaliate/goat/loly
	name = "Space pig"
	...
	speak_emote = list("brays")
	emote_hear = list("brays.")
	emote_see = list("кидает зигу.", "скачет.", "пытается зажечь покрышки, но их нет.")
	speak_chance = 1
	turns_per_move = 5
	see_in_dark = 6
	butcher_results = list(/obj/item/weapon/reagent_containers/food/snacks/meat/rawbacon = 6)
	response_help  = "гладiт по загрiвку"
	response_disarm = "gently pushes aside"
	response_harm   = "kicks"
	faction = list("neutral")
	attack_same = 1
